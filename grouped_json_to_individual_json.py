# Converts the grouped JSON file in to individual JSON files for each group/record type
...
for record_type, records in grouped_data.items():
    # Create a JSON file within the "data/mocks" directory with the type as the file name
    file_name = f"{record_type}.json"
